      ...
      <div class="container-fluid detached-nav">
        ...
        <ul class="list-unstyled topbar-menu float-end mb-0">
          ...
          <li class="dropdown notification-list topbar-dropdown">
            <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
              <img src={require('../../assets/images/us.jpg')} alt="user-image" class="me-0 me-sm-1" height="12" />
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated topbar-dropdown-menu">
              ...
              <a href="javascript:void(0);" class="dropdown-item notify-item">
                <img src="images/germany.jpg" alt="user-mage" class="me-1" height="12" /> <span class="align-middle">German</span>
              </a>
                    ...
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <div class="notify-icon">
                          <img src={require('../../assets/images/avatar-2.jpg')} class="img-fluid rounded-circle" alt="user" />
                        </div>
                      </div>
                      <div class="flex-grow-1 text-truncate ms-2">
                ...
                <a href="javascript:void(0);" class="dropdown-item p-0 notify-item card read-noti shadow-none mb-2">
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <div class="notify-icon">
                          <img src="images/avatar-4.jpg" class="img-fluid rounded-circle" alt="avatar" />
                        </div>
                      </div>
                      <div class="flex-grow-1 text-truncate ms-2">
          ...
          <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
              <span class="account-user-avatar">
                <img src={require('../../assets/images/avatar-1.jpg')} alt="user-image" class="rounded-circle" />
              </span>
              <span>
